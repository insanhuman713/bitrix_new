<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();
    use Bitrix\Main\Page\Asset; //импорт нужного класса через пространство имён.
?>
...
<head>
    <!-- Выводит мета теги и кодировку стили и js-->
    ...
    <?php
        ...
        Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/css/css/et-line.css');
...
<!-- Шапка сайта (меню) -->
<?
    if($APPLICATION->GetCurPage()==='/') {$classHeader = 'transparent-header';}
    else { $classHeader = 'white-bg';}
?>
<header id="sticky-header" class="header-area header-wrapper <?=$classHeader?>">
    <!-- Меню (для десктопа) -->
