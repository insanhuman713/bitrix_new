...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
	...
	if(check_bitrix_sessid())
	{
		...
		if(empty($arResult["ERROR_MESSAGE"]))//если нет вывода ошибок, то идет отправка данных
		{
			$arFields = Array(//Поля формы, которые можно добовлять
...
$this->IncludeComponentTemplate();//Подключается шаблон компонента.
